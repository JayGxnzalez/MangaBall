...
async function searchResults(keyword, page = 1) {
    ...
    try {
        ...
        console.log("[MangaBall] Parsed response code:", json.code, "data length:", json.data ? json.data.length : "no data field");
        ...
        console.log("[MangaBall] searchResults error:", err.message || err, err.stack || "");
        return [];
    }
}
